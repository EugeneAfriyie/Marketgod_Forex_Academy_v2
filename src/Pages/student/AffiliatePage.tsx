    ...
    if (!isRegistered) {
        ...
        <motion.div initial="hidden" animate="show" variants={container} className={`relative overflow-hidden rounded-[3rem] border shadow-2xl ${isDark ? "border-white/5 bg-[#0a0a0a]" : "border-black/5 bg-white"}`}>
          ...
          <div className="relative z-10 p-10 md:p-16 lg:p-24 flex flex-col items-center text-center">
            ...
            <button onClick={handleRegister} disabled={isRegistering} className="group relative overflow-hidden inline-flex items-center justify-center gap-3 rounded-2xl bg-mg-gold px-12 py-5 text-sm font-black uppercase tracking-[0.15em] text-black shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(212,175,55,0.6)] disabled:opacity-70 disabled:hover:scale-100">
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={container} className="relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
             <motion.div variants={item} className={`p-8 rounded-[2.5rem] border text-center transition-transform hover:-translate-y-1 hover:shadow-xl ${isDark ? "bg-[#111111] border-white/5" : "bg-[#faf7f0] border-black/5"}`}>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={container} className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            ].map((step, idx) => (<motion.div variants={item} key={idx} className={`flex flex-col items-center p-8 rounded-[2rem] border bg-opacity-50 backdrop-blur-sm ${isDark ? "bg-[#111111] border-white/5" : "bg-[#faf7f0] border-black/5"}`}>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} variants={container}>
          <div className="grid gap-6 md:grid-cols-2">
            ...
            ].map((benefit, idx) => (<motion.div variants={item} key={idx} className={`flex items-start gap-5 p-8 rounded-[2.5rem] border transition-transform hover:-translate-y-1 ${isDark ? "bg-white/[0.02] border-white/5 hover:border-mg-gold/30" : "bg-white border-black/5 hover:border-mg-gold/30"}`}>
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={container} className="relative overflow-hidden rounded-[3rem] p-10 md:p-16 text-center shadow-2xl border border-mg-gold/30">
          ...
          <div className="relative z-10">
            ...
            <button onClick={handleRegister} disabled={isRegistering} className="group relative overflow-hidden inline-flex items-center gap-3 rounded-2xl bg-mg-gold px-10 py-5 text-sm font-black uppercase tracking-[0.15em] text-black shadow-[0_0_30px_rgba(212,175,55,0.5)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(212,175,55,0.7)] disabled:opacity-70 disabled:hover:scale-100">
      ...
      <motion.div initial="hidden" animate="show" variants={container} className="grid md:grid-cols-3 gap-6">
        <motion.div variants={item} className={`md:col-span-2 p-8 rounded-[2rem] border shadow-lg ${isDark ? "bg-[#111111] border-white/10" : "bg-white border-black/10"}`}>
          ...
          <div className={`flex items-center gap-3 p-2 rounded-2xl border ${isDark ? "bg-black/50 border-white/10" : "bg-gray-50 border-black/10"}`}>
            ...
            <button onClick={handleCopy} className={`flex items-center gap-2 px-6 py-4 rounded-xl font-bold text-sm transition-all ${copied ? "bg-green-500 text-white" : "bg-mg-gold text-black hover:scale-[1.02]"}`}>
      ...
      <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={container} className="space-y-6">
        ...
        <motion.div variants={item} className={`rounded-[2.5rem] border shadow-xl overflow-hidden ${isDark ? "border-white/10 bg-[#111111]" : "border-black/10 bg-white"}`}>
          <div className="divide-y divide-white/5 dark:divide-white/10 divide-black/5">
            {activeRecentReferrals.length === 0 ? (<div className="p-12 flex flex-col items-center justify-center text-center">
        ...
        {showAllReferralsModal && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[110] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm" onClick={() => setShowAllReferralsModal(false)}>
            <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 20 }} onClick={(e) => e.stopPropagation()} className={`w-full max-w-2xl flex flex-col overflow-hidden rounded-[2rem] border shadow-2xl max-h-[85vh] ${isDark ? "border-white/10 bg-[#111111]" : "border-black/10 bg-white"}`}>
              ...
              <div className="overflow-y-auto p-2">
                <div className="divide-y divide-white/5 dark:divide-white/10 divide-black/5">
                  {activeAllReferrals.length === 0 ? (<div className="p-12 flex flex-col items-center justify-center text-center">
                      <div className="h-16 w-16 mb-4 rounded-full bg-mg-gold/10 text-mg-gold flex items-center justify-center">
                        <Users size={32}/>
                      </div>
                      <h3 className={`text-xl font-bold mb-2 ${isDark ? "text-white" : "text-gray-900"}`}>{"No referrals yet"}</h3>
